...
def calcBest(x_train, y_train, x_val, y_val, lamb, iter):
  w = np.zeros(len(x_train[0]))
  w, b, J_history = gradient_descent(x_train, y_train, w, 1, compute_cost_reg, compute_gradient_reg, 0.01, iter, lamb)
